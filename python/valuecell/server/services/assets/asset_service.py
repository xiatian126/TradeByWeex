        ...
        try:
            ...
            if not historical_prices:
                return {
                    "success": False,
                    "error": (
                        f"Historical price data not available for '{ticker}'. "
                        "All data adapters failed to fetch data. This may be due to: "
                        "1) Rate limiting from data providers, "
                        "2) Network connectivity issues, "
                        "3) The ticker not being supported by available adapters, or "
                        "4) The requested date range having no available data. "
                        "Please try again later or check if the ticker is correct."
                    ),
                    "ticker": ticker,
                }
